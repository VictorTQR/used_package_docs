---
title: "Insert Documents | Zvec"
source: "https://zvec.org/en/docs/data-operations/insert/"
author:
published:
created: 2026-02-27
description:
...
[Python API Reference](https://zvec.org/api-reference/python/collection/#zvec.model.collection.Collection.insert) [Node.js API Reference](https://zvec.org/api-reference/nodejs/classes/ZVecCollection#insertsync)

Use the **`insert()`** method to add one or more new [documents](https://zvec.org/en/docs/concepts/data-modeling/#documents) (`Doc`) to a [collection](https://zvec.org/en/docs/collections/).
...
[🐛 Report an Issue](https://github.com/alibaba/zvec/issues)[Data Operations](https://zvec.org/en/docs/data-operations/)
...
](https://zvec.org/en/docs/data-operations/upsert/)

### On this page

[Document `Doc`](https://zvec.org/en/docs/data-operations/insert/#document-doc) [Insert a Single Document](https://zvec.org/en/docs/data-operations/insert/#insert-a-single-document) [Insert a Batch of Documents](https://zvec.org/en/docs/data-operations/insert/#insert-a-batch-of-documents) [Insert Documents with Sparse Vectors](https://zvec.org/en/docs/data-operations/insert/#insert-documents-with-sparse-vectors) [Insert Documents with Multiple Fields and Vectors](https://zvec.org/en/docs/data-operations/insert/#insert-documents-with-multiple-fields-and-vectors)